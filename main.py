...
Original file is located at
    https://colab.research.google.com/drive/1L0MBFDm6XDZqzzTQ3SZUfp3qCMMM5feo
"""
...
# Transformasi untuk training (TANPA augmentasi sesuai permintaan)
# Hanya resize dan normalisasi
...
print("⚠️  Data augmentation telah dinonaktifkan sesuai permintaan")

# Konfigurasi Training Sederhana
# Tidak menggunakan teknik augmentasi lanjutan seperti mixup
# sesuai dengan permintaan untuk fokus pada model Plain-34

print("✅ Setup training sederhana - tanpa mixup, tanpa augmentasi data")

"""## Analisis Dataset

Mari kita lihat struktur dataset dan distribusi kelas terlebih dahulu sebelum training.

## Arsitektur Model

**Model yang Dipilih: Plain-34**
- Plain-34 Network: ResNet-34 architecture **tanpa residual connections**
- Jumlah parameter: ~21M (dalam batas < 26M parameter)
- **Tidak menggunakan pre-trained weights** - training dari scratch
- Arsitektur yang lebih sederhana dibanding ResNet karena tidak ada skip connections
- Berguna untuk membandingkan pentingnya residual connections dalam deep learning
...
- Menggunakan He initialization untuk weights
"""
