# -*- coding: utf-8 -*-
"""Tugas Resnet Tahap 3 (D).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1UwuwwnblGBpwS8xMuMjzHu5NOGnuburh
"""
...
class ResNetBlock(nn.Module):
    def __init__(self, in_channels, out_channels, stride=1, downsample=None):
        ...
        # BatchNorm dan ReLU dulu sebelum Conv
    ...
    def forward(self, x):
        ...
        # Tambah residual connection (skip connection)
        out += identity
        return out
