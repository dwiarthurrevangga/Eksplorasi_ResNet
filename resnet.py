...
class ResNetBlock(nn.Module):
    """
    Resnet Block with residual connection (has skip connection).
    """
...
print("\n---")
print("✅ Model ResNet berhasil diintegrasikan dan siap untuk training.")
print(f"Loss pada langkah test ini: {loss.item():.4f}")
print("🔍 Model menggunakan arsitektur ResNet-34 dengan residual connections")
